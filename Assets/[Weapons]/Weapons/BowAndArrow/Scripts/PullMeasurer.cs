...
public class PullMeasurer : XRBaseInteractable
{
    ...
    protected override void OnSelectEntered(SelectEnterEventArgs args)
    {
        ...
        {
            controller.SendHapticImpulse(.5f, .05f);
        }
    }
    ...
    public override void ProcessInteractable(XRInteractionUpdateOrder.UpdatePhase updatePhase)
    {
        ...
        if (isSelected)
        {
            ...
            {
                controller.SendHapticImpulse(PullAmount / 5f, .05f);
            }

            //polish
            stringLine.material.SetColor("_EmissionColor", Color.Lerp(stringNormalCol, stringPulledCol, PullAmount));
        }
    }
